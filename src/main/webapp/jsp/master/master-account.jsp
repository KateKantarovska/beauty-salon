                    ...
                    <div class="tab-pane active">
                        <div class="d-flex justify-content-center">
                            <div class="card-body p-4">
                                <jsp:useBean id="user" scope="session" type="model.Master"/>
                                <form action="${pageContext.request.contextPath}/app" method="post">
                                    ...
                                    <div class="form-outline mb-4">
                                        <label class="form-label" for="first-name-ua">
                                            <fmt:message key="label.first-name.ua"/>
                                        </label>
                                        <input type="text" class="form-control" id="first-name-ua" name="firstName"
                                               value="${user.name}" readonly/>
                                    </div>

                                    <div class="form-outline mb-4">
                                        <label class="form-label" for="surname-ua">
                                            <fmt:message key="label.surname.ua"/>
                                        </label>
                                        <input type="text" class="form-control" id="surname-ua" name="surname"
                                               value="${user.surname}"
                                               readonly/>
                                    </div>
                                    ...
                                    <div class="form-outline mb-4">
                                        ...
                                        <input type="text" class="form-control" id="first-name-en" name="firstName"
                                               value="${user.nameEN}" readonly/>
                                    </div>

                                    <div class="form-outline mb-4">
                                        <label class="form-label" for="surname-en">
                                            <fmt:message key="label.surname.en"/>
                                        </label>
                                        <input type="text" class="form-control" id="surname-en" name="surname"
                                               value="${user.surnameEN}"
                                               readonly/>
                                    </div>
