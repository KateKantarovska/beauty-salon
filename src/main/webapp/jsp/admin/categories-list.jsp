                ...
                <div class="tab-pane active">
                    <div>
                        <h3 class="text-uppercase text-center mb-2">
                            <fmt:message key="header.categories-list"/>
                        </h3>
                    </div>
                        ...
                        <table class="table table-bordered table-striped table-hover text-center align-middle">
                            ...
                            <c:forEach var="category" items="${categoriesList}">
                                <tr>
                                    ...
                                    <td>
                                        <a href="${pageContext.request.contextPath}/app?command=editCategoryForm&id=${category.id}"
                                        class="btn btn-sm btn-outline-info">
                                            <fmt:message key="button.edit"/>
                                        </a>
                                    </td>
                                    <td>
                                        <a href="${pageContext.request.contextPath}/app?command=deleteCategory&id=${category.id}"
                    ...
                    <div class="d-flex justify-content-center">
                        <a href="${pageContext.request.contextPath}/admin/add-new-category"
                           class="btn btn-outline-info">
                            <fmt:message key="button.add-new-category"/>
                        </a>
                    </div>
                </div>
            </div>
