                    ...
                    <div class="d-flex justify-content-center">
                        <div class="card-body p-4">
                            <h3 class="text-uppercase text-center mb-2">
                                <fmt:message key="title.edit-category"/>
                            </h3>
                            <form action="${pageContext.request.contextPath}/app" method="post">
                                ...
                                <div class="form-outline mb-4">
                                    ...
                                    <input type="text" value="${category.nameUA}" class="form-control" id="nameUA"
                                           name="nameUA"
                                ...
                                <div class="form-outline mb-4">
                                    ...
                                    <input type="text" value="${category.nameEN}" class="form-control" id="nameEN"
                                           name="nameEN"
