                ...
                <div class="tab-pane active">
                    <div class="d-flex justify-content-center">
                        <div class="card-body p-4">
                            <jsp:useBean id="category" scope="request" type="model.Category"/>
                            <h3 class="text-uppercase text-center mb-2">
                                <fmt:message key="header.add-new-service"/> "${category.nameEN}"
                            </h3>
                            <form action="${pageContext.request.contextPath}/app" method="post">
                                <input type="hidden" name="command" value="addNewService"/>
                                ...
                                <div class="form-outline mb-4">
                                    ...
                                    <input type="number" class="form-control" id="priceUAH" name="priceUAH"
                                ...
                                <div class="form-outline mb-4">
                                    ...
                                    <input type="number" class="form-control" id="priceUSD" name="priceUSD"
                                           pattern="[0-9]+" required/>
                                </div>
